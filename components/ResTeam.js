            ...
            <Text style={styles.titles}>Team 01</Text>
                ...
                <View style={styles.pokamios}>
                    ...
                    <View style={styles.grup1text}>
                        ...
                        <Text style={styles.pokename} >{user.slot1.name}</Text>
                        <Text style={styles.pokename} >{user.slot2.name}</Text>
                        <Text style={styles.pokename} >{user.slot3.name}</Text>
                    ...
                    <View style={styles.grup1}>
                     ...
                     <View style={styles.grup1text}>
                        ...
                        <Text style={styles.pokename}>{user.slot4.name}</Text>
                        <Text style={styles.pokename}>{user.slot5.name}</Text>
                        <Text style={styles.pokename}>{user.slot6.name}</Text>
...
const Weakness =({user})=>{
    return(
        <View style={[{borderRadius:10},styles.stats]}>
